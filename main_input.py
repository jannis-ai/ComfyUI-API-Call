...
os.environ["NO_PROXY"] = "192.168.71.33,127.0.0.1,localhost"
...
def run_local_api(prompt_text, width, height):
    ...
    # 2. DYNAMICALLY REWRITE THE PROMPT AND DIMENSIONS
    # Target CLIPTextEncode node for text
    if "57:27" in workflow_data:
        workflow_data["57:27"]["inputs"]["text"] = prompt_text
    
    # Target EmptySD3LatentImage node for size
    if "57:13" in workflow_data:
        workflow_data["57:13"]["inputs"]["width"] = width
        workflow_data["57:13"]["inputs"]["height"] = height
...
if __name__ == "__main__":
    # Define your dynamic execution values here
    USER_PROMPT = "一位中国男性"
    USER_WIDTH = 1024
    USER_HEIGHT = 1024
    
    run_local_api(prompt_text=USER_PROMPT, width=USER_WIDTH, height=USER_HEIGHT)
